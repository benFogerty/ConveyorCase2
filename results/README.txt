...
================================================================================
  ...
  <method>/<instance_id>/ - (only when --save-playbook) Playbooks grouped by method:
    ...
    input.csv              - Per-order input (order_id, conv_num, 8 shape columns) used for FIFO evaluation
    input_conveyor.csv     - M3_Example per-conveyor format (conv_num + 8 shape columns)
